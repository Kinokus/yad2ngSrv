...
const ApartmentSchema = new Schema({
    ...
    "rooms": {type: Number, required: false, default: -2},
    "arnona": {type: Number, required: false, default: -2},
    "balconies": {type: Number, required: false, default: -2},
    "floor": {type: String, required: false, default: ''},
    "meters": {type: Number, required: false, default: -2},
    ...
    "totalFloors": {type: Number, required: false, default: -2},
    "numberPayments": {type: Number, required: false, default: -2},
    "parking": {type: Number, required: false, default: false},
    "levelQuietOnStreet": {type: Number, required: false, default: -2},
    "streetParking": {type: Number, required: false, default: -2},
    "proximityCommercialServices": {type: Number, required: false, default: -2},
    "accessibilityPublicTransportation": {type: Number, required: false, default: -2},
